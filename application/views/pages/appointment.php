                        ...
                        <div class="row" style="    border-bottom: 1px solid #E5E5E5;">
                            <div class="col-md-4" >
                                <div class="form-group" style="font-color:#dd0101">
                                    ...
                                    <select class="form-control" style="padding:5px;"  name="select_date" id="dateselection" style="" required ng-model="dateselection<?php echo $value['id']; ?>"  ng-init="dateselection<?php echo $value['id']; ?> = '<?php echo $value['dates'][0]['date']; ?>'" >
                                ...
                                if ($value) {
                                    foreach ($dataes as $dtkey => $dtvalue) {
                                        ...
                                        <div class="form-group tab-pane " ng-if="dateselection<?php echo $value['id']; ?> == '<?php echo $dtvalue['date']; ?>'" style="font-color:#dd0101">
                                            ...
                                            <select class="form-control" style="padding:5px;"  name="select_time" id="select_time" style="" required />
                                            <?php
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" style="font-color:#dd0101">
                                    ...
                                    <select class="form-control" style="padding:5px;"  name="referral" id="select_time" style="" required >
                    ...
                    <div class = "modal-footer">
                        ...
                        <button type = "submit" name="submit" class="btn btn-danger" style="background: #dd0101;    margin: 10px 0px;" >
                          ...
                          <button type = "button" style="    background-color: #dd0101;
                                border: 1px solid #dd0101;" class = " btn btn-danger btn-xm " data-dismiss = "modal" aria-hidden = "true">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <ul style="    margin-bottom: 0px;margin-top: 10px;    font-size: 10px;">
                                        ...
                                        <li class="">
                                            ...
                                            <span class="timeing_open">Mon - Fri</span>: 10:00 AM to 08:00 PM<br/>
                                            <span class="timeing_open">Sat</span>: 11:00 AM to 07:00 PM<br/>
                                            <span class="timeing_open">Sun & Pub. Holidays</span>: 12:00 AM to 05:00 PM
                                        </li>
